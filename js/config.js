/**
 * Site Config
 * 站点非文案配置：作品数据、社交链接、品牌图标
 * 注意：所有用户可见文案一律存放于 i18n.js 字典，此处仅存结构化数据
 */
...
window.SITE = {
    ...
    /**
     * 作品列表
     * preview 为 iframe 静态预览源（仅嵌入已确认放行 X-Frame-Options 的站点）；
     * 为 null 时弹窗回退显示静态截图；
     * image 仅在无 preview / previewImg 时作为弹窗静态快照使用；
     * color 为卡片信号色（pink/blue/red/green/cyan/orange/purple），对应 variables.css 多彩信号板
     */
    works: [
        {
            id: 'simplenavy',
            year: '2026',
            color: 'pink',
            link: 'https://simplenavy.netlify.app/',
            preview: 'https://simplenavy.netlify.app/',
            linkKey: 'works.view'
        },
        {
            id: 'othershore',
            year: '2026',
            color: 'blue',
            link: 'https://simplenavy.netlify.app/othershoregamestudio/',
            preview: 'https://simplenavy.netlify.app/othershoregamestudio/',
            linkKey: 'works.view'
        },
        {
            id: 'soloplugin',
    ...
    /** 联系方式 */
    contact: {
        email: '3097914916@qq.com',
        location: 'i18n:contact.location.value'
    },
    ...
    /** 品牌图标（SVG path，官方品牌原色不染色，交由 currentColor 控制但保持原始形态） */
    icons: {
