...
(function () {
    ...
    var DICT = {
        'zh-CN': {
            ...
            'works.aiprojects.title': 'Some AI Projects',
            'works.aiprojects.desc': '一些非系统化的 AI 工具集合，探索人工智能的实用场景。',
            'works.mcmod.title': 'MC Java 模组',
            'works.mcmod.desc': '使用 AI 辅助开发的 Minecraft 1.20.1 Java 版模组。',
            'works.view': '查看项目',
            'works.viewCode': '查看源码',
            'works.viewBlog': '查看博客',
            'works.viewPreview': '在线预览',
            'works.wip': '开发中',
        ...
        'en-US': {
            ...
            'works.cat.ai': 'AI Toolkit',
            'works.cat.mod': 'Game Mod',
            'works.simplenavy.title': 'SimpleNAVY',
            ...
            'works.aiprojects.title': 'Some AI Projects',
            'works.aiprojects.desc': 'A collection of unsystematic AI tools exploring practical scenarios.',
            'works.mcmod.title': 'MC Java Mod',
            'works.mcmod.desc': 'A Minecraft 1.20.1 Java Edition mod developed with AI assistance.',
            'works.view': 'View Project',
            'works.viewCode': 'View Source',
            'works.viewBlog': 'View Blog',
            'works.viewPreview': 'Live Preview',
            'works.wip': 'In Development',
